...
//         const user1TicketsResponse = await lottery.viewUserTicketsInfoForLotteryId(user1, currentLotteryId, 0, 40, {from: user1});
//         const user2TicketsResponse = await lottery.viewUserTicketsInfoForLotteryId(user2, currentLotteryId, 0, 40, {from: user2});
